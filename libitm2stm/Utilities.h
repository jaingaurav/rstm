...
/// taking sizeof(void*) - 1 and treating its unsigned representation as a
/// mask. Then we do a bitwise & and pick out the offset bits.
inline size_t
...
/// We always do word-aligned accesses into the TM ABI (with an appropriate
...
///
/// NB: When the parameters are compile-time constants we expect this to become
///   a simple constant in the binary when compiled with optimizations.
inline uintptr_t
